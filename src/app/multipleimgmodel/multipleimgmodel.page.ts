...
@Component({
  selector: 'app-multipleimgmodel',
  templateUrl: './multipleimgmodel.page.html',
  styleUrls: ['./multipleimgmodel.page.scss'],
})
export class MultipleimgmodelPage implements OnInit {
